function loadFunc() {
  ...
  function addLi() {
    document.getElementById("myList").innerHTML +=
      '<li onclick="toggleRemoved(event);" ondblclick="liDblClick(event);" onblur="loseEditables();" spellcheck=false>' + document.getElementById("myInput").value + window.moreIconData;
