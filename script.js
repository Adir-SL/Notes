function loadFunc() {
  ...
  function addLi() {
    document.getElementById("myList").innerHTML +=
      '<li onclick="toggleRemoved(event);" ondblclick="liDblClick(event);" onblur="loseEditables();" spellcheck=false>' + document.getElementById("myInput").value + '<modbtns><button class="menuBtn">Delete<i class="material-icons">more_vert</i></button><morebtns><button class="editBtn">Edit<i class="material-icons">edit</i></button><button class="delBtn"><i class="material-icons">delete</i></button><button class="closeBtn">Cancel<i class="material-icons">close</i></button></morebtns></modbtns></li>';
